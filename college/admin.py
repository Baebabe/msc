...
# Create single instance of custom admin site
...
class SubjectTeacherAdmin(ModelAdmin):
    save_as = True
    list_filter = (
        ('year', custom_titled_filter('Academic Year')), 
        ('batch__year__name', custom_titled_filter('Batch Year')),
        ('batch__programme__name', custom_titled_filter('Program Name')), 
        'semester',
        ('subject_teacher__first_name', custom_titled_filter('Teachers First Name')),
        ('subject__name', custom_titled_filter('Subject Name')))
    list_display = (
        'year', 'batch', 'semester', 'subject_teacher', 'subject')
    search_fields = (
        'year__name', 'batch__year__name', 'batch__programme__name', 'semester', 
        'subject_teacher__first_name', 'subject__name')
...
admin_site.register(AssignSubjectTeacher, SubjectTeacherAdmin)
...
admin_site.register(Programme, ImportExportModelAdmin)
admin_site.register(AffiliatedInstitute, ImportExportModelAdmin)
admin_site.register(Year, ImportExportModelAdmin)

# Unregister from default admin site to avoid duplicates
from django.contrib import admin
